...
export const metadata: Metadata = createPageMetadata({
  ...
  path: "/docs/kinetics/pelvis-support-upper-body-weight",
});
  ...
  return (
    <>
      <div className={style.container}>
        ...
        <p>
          これでも難しい人はいると思います。その場合、骨盤をマウスを動かす方向と逆に傾けるイメージでAIMしてみてください。そうすると自然と骨盤周りの筋肉が緩んで上半身の重さを骨盤周りで支えるイメージがつかめると思います。
        </p>
